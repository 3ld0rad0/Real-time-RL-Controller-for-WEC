...
function App() {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-slate-100 text-slate-900 font-sans selection:bg-indigo-100 selection:text-indigo-900 overflow-hidden rounded-2xl border border-slate-300 shadow-2xl">
      <TitleBar />
